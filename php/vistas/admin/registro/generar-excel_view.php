<div class="page">
    ...
    <div class="form-container">
        <form class='inside-form' id='general-form' action="php/controladores/generarExcel.php" method="post">
            <div class="form__division"></div>
            <h2 class='form__heading'>Genera un excel de registro de prestamos</h2>
            <div class="form__division"></div>
            <div class='form__row'>
                    ...
                    <?php
                        ...
                        if(mysqli_num_rows($isThereDeptos) >= 1) {
                            ...
                            <div class='warning-depto'>
                                <p>No existe ningun departamento para generar este excel.</p>
                            </div>
                            ";
                        }
                ...
                <div class="page__filter" style='flex: 1 1 20rem;'>
                    ...
                    <?php
                        ...
                        if(mysqli_num_rows($isThereUsers) >= 1) {
                            ...
                            $print.= "
                            <div class='warning-depto'>
                                <p>No existe ningun usuario para generar este excel.</p>
                            </div>
                            ";
                        }
